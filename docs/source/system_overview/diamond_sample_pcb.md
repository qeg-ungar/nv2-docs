...
*Add: description of how diamond is fixed to PCB (crystal bond, silver paint, etc.), wire bonding or direct contact, strain considerations.*

## Diamond Specifications

| Parameter | Value | Notes |
|-----------|-------|-------|
| Type | | e.g., electronic grade, CVD |
| NV density | | ppb |
| Surface cut | | e.g., [100], [111] |
| Surface treatment | | e.g., acid clean, annealing |
| Dimensions | | mm × mm × mm |
...
The Heater PID maintains the sample temperature. *Add: PID controller model, setpoint range, sensor type and placement, typical stability.*
