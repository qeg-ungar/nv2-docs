...
The OPX is the central controller. It connects to the PC via PCIe and is programmed using QUA (Quantum Orchestration Language).

*Add: OPX model, channel assignments, firmware version, QUA version.*

### Channel Map

| OPX Port | Signal | Destination |
|----------|--------|-------------|
| | | |
