...
This page describes the software stack used to control the NV2 instrument, acquire data, and run experiments.
...
processing on the OPX. *Add: directory location, how to run a sequence, configuration files.*
