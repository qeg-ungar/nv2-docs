...
.. warning::
   ...
   532 nm laser light is hazardous to eyes. Wear appropriate laser safety goggles
   (OD ≥ 4 at 532 nm) at all times when the laser shutter is open.
...
.. list-table::
   ...
   * - Symptom
     ...
     - Fix
   * - No APD counts
     - Collection path misaligned
     - Re-align fiber coupler
   * - Low count rate
     - AOM misaligned or power low
     - Re-optimize AOM
   * - Bright background
     - Stray scatter
     - Check beam dumps, irises
