Calibration & Building Procedures
==================================
...
*Add a short checklist here for daily startup checks once the system is fully commissioned.*
...
.. list-table::
   ...
   * - Laser power at objective
     -
     - Realign AOM
   * - APD count rate (no MW)
     -
     - Check collection path
   * - ODMR contrast
     -
     - See :doc:`CW ODMR <cw_odmr>`
