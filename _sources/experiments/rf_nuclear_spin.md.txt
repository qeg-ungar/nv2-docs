...
The ¹⁴N nucleus (I = 1) is hyperfine coupled to the NV electron spin with A_∥ ≈ −2.16 MHz.
...
frequency (for ¹⁴N: γ_N ≈ 3.08 kHz/G).
...
Run a nuclear ODMR sweep (electron pre-selected in m_s = −1) to identify the nuclear transition frequency.
...
*Add: analysis notebook, observable of interest, how to extract nuclear spin polarization from electron readout.*
