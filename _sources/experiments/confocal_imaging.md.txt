...
| Mode | Description |
|------|-------------|
| XY scan | Raster scan at fixed Z; generates 2D fluorescence map |
| XZ / YZ scan | Cross-section scan for Z-focus optimization |
| Line scan | Single line for fast diagnostics |
| Point measurement | Fixed position for time-resolved measurements |
...
|-----------|--------------|-------------|
| Scan range X | 10–50 µm | Physical scan size |
| Scan range Y | 10–50 µm | |
| Pixels | 100 × 100 | Resolution |
| Pixel dwell time | 5–20 ms | Integration per pixel |
| Laser power | | µW at objective |
