...
*Add: how to distinguish aligned vs. misaligned patterns, example ODMR spectra.*
...
Once aligned, record the magnet stage position and field strength at the sample.
...
.. list-table::
   ...
   * - Magnet stage Z
     -
     - mm
   * - NV splitting (aligned family)
     -
     - MHz
   * - Estimated \|B\| at sample
     -
     - G
